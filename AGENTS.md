...
- `llama-manager/main.js` — activity-aware reverse proxy; records inference activity, exposes `/status` for the exporter; Docker socket mounted for future scale-to-zero autoscaler
