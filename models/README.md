...
|------------------------|---------------------------------------------|---|------|-----|-------------------------------------------------------------------|
| `panther-minor` 🧠 👀  | `unsloth/Qwen3.5-35B-A3B-GGUF`              | 8 | 128k | 6k  | Balanced general-purpose model for daily assistance               |
| `panther-coder`        | `unsloth/Qwen3-Coder-30B-A3B-Instruct-GGUF` | 8 | 128k | 6k  | Balanced default for daily coding work                            |
| `panther-coder-next`   | `unsloth/Qwen3-Coder-Next-GGUF`             | 4 | 128k | 8k  | Advanced agentic capabilities model for complex coding tasks      |
| `panther-coder-large`  | `unsloth/Qwen3-Coder-Next-GGUF`             | 8 | 256k | 16k | High precision (slower inference) model for complex code planning |
